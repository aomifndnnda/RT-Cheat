...
<div class="shizoval__content">
        <center><div class="sc-bwzfXH jUvdDa" <h1 style="font-size: 22px">Ameli's Hack</h1></center>
		...
		<div id="infoWindow">
            ...
            <a href="https://www.youtube.com/user/itsnikzx3?sub_confirmation=1" target="_blank"><center><font id="nig" color="#C2A10B">Ameli Control <3</center></font></p>
...
console.clear();
console.log("[Ameli's Hack] has been loaded");
